            ...
            <div className="flex md:space-x-6 space-x-2 mt-12 md:px-8 px-1">
                <div className="flex flex-col">
                    <div className="text-sm text-[#353535] items-center flex m-auto h-10 w-10 rounded-full bg-yellow-600 mx-auto justify-center">
                        <a href={`tel:${shopData?.phone}`} className="flex justify-center m-auto">
                ...
                <div className="flex flex-col">
                    <div className="text-sm text-[#353535] items-center flex m-auto h-10 w-10 rounded-full bg-yellow-600 mx-auto justify-center">
                        <a href={`mailto:${shopData?.email}`} className="flex justify-center m-auto">
                ...
                <div className="flex flex-col">
                    <div className="text-sm text-[#353535] items-center flex m-auto h-10 w-10 rounded-full bg-yellow-600 mx-auto justify-center">
                        <a href={shopData?.phone} className="flex justify-center items-center m-auto">

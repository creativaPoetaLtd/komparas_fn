      ...
      <table className="w-full rounded-md">
        <thead className="w-full bg-slate-200 rounded-md">
          <tr className="w-full shadow-sm rounded-md">
            ...
            <th className="w-[20%] text-sm font-bold text-start py-3 px-2">Address</th>
        ...
        <tbody className="w-full mt-3">
          <tr className="w-full mt-3 shadow-sm">
            <td className="w-[10%] text-sm font-medium py-2 px-2">1</td>
            <td className="w-[10%] text-sm font-medium py-2 px-2">
              <div className="w-[50px] h-[50px] rounded-full bg-gray-400"></div>
            </td>
            <td className="w-[20%] text-sm font-medium py-2 px-2">Lorem ipsum</td>
            <td className="w-[20%] text-sm font-medium py-2 px-2">Lorem ipsum</td>
            <td className="w-[20%] text-sm font-medium py-2 px-2">Lorem ipsum</td>
            <td className="w-[20%] text-sm font-medium py-2 px-2">Lorem ipsum</td>
            <td className="w-[10%] text-sm font-medium py-2 px-2">
          ...
          <tr className="w-full mt-3 shadow-sm">
            <td className="w-[10%] text-sm font-medium py-2 px-2">2</td>
            <td className="w-[10%] text-sm font-medium py-2 px-2">
              <div className="w-[50px] h-[50px] rounded-full bg-gray-400"></div>
            </td>
            <td className="w-[20%] text-sm font-medium py-2 px-2">Lorem ipsum</td>
          ...
          <tr className="w-full mt-3 shadow-sm">
            <td className="w-[10%] text-sm font-medium py-2 px-2">3</td>
            <td className="w-[10%] text-sm font-medium py-2 px-2">
              <div className="w-[50px] h-[50px] rounded-full bg-gray-400"></div>
            </td>
            <td className="w-[20%] text-sm font-medium py-2 px-2">Lorem ipsum</td>
          ...
          <tr className="w-full mt-3 shadow-sm">
            <td className="w-[10%] text-sm font-medium py-2 px-2">4</td>
            <td className="w-[10%] text-sm font-medium py-2 px-2">
              <div className="w-[50px] h-[50px] rounded-full bg-gray-400"></div>
            </td>
            <td className="w-[20%] text-sm font-medium py-2 px-2">Lorem ipsum</td>
          ...
          <tr className="w-full mt-3 shadow-sm">
            <td className="w-[10%] text-sm font-medium py-2 px-2">5</td>
            <td className="w-[10%] text-sm font-medium py-2 px-2">
              <div className="w-[50px] h-[50px] rounded-full bg-gray-400"></div>
            </td>
            <td className="w-[20%] text-sm font-medium py-2 px-2">Lorem ipsum</td>
          ...
          <tr className="w-full mt-3 shadow-sm">
            <td className="w-[10%] text-sm font-medium py-2 px-2">6</td>
            <td className="w-[10%] text-sm font-medium py-2 px-2">
              <div className="w-[50px] h-[50px] rounded-full bg-gray-400"></div>
            </td>
            <td className="w-[20%] text-sm font-medium py-2 px-2">Lorem ipsum</td>

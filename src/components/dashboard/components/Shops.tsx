    ...
    <table className="w-full rounded-md">
      ...
      <tbody className="w-full mt-3">
        <tr className="w-full mt-3 shadow-sm">
          <td className="w-[10%] text-sm font-medium py-4 px-2">1</td>
          
          <td className="w-[20%] text-sm font-medium py-4 px-2">Lorem ipsum</td>
          <td className="w-[20%] text-sm font-medium py-4 px-2">Lorem ipsum</td>
          <td className="w-[20%] text-sm font-medium py-4 px-2">Lorem ipsum</td>
          <td className="w-[20%] text-sm font-medium py-4 px-2">Lorem ipsum</td>
          <td className="w-[20%] text-sm font-medium py-4 px-2">Lorem ipsum</td>
        ...
        <tr className="w-full mt-3 shadow-sm">
          <td className="w-[10%] text-sm font-medium py-4 px-2">2</td>
        ...
        <tr className="w-full mt-3 shadow-sm">
          <td className="w-[10%] text-sm font-medium py-4 px-2">3</td>
        ...
        <tr className="w-full mt-3 shadow-sm">
          <td className="w-[10%] text-sm font-medium py-4 px-2">4</td>
        ...
        <tr className="w-full mt-3 shadow-sm">
          <td className="w-[10%] text-sm font-medium py-4 px-2">5</td>
        ...
        <tr className="w-full mt-3 shadow-sm">
          <td className="w-[10%] text-sm font-medium py-4 px-2">6</td>

...
const BlogEditModal: React.FC<BlogEditModalProps> = ({ isOpen, onClose, onSuccess, blogId }) => {
  ...
  const removeCurrentContentPhoto = (indexToRemove: number) => {
    setCurrentContentPhotos(prev => prev.filter((_, index) => index !== indexToRemove));
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Add existing content photos as a string to preserve them
      formData.append('existingContentPhotos', JSON.stringify(currentContentPhotos));
      ...
      setErrorMessage(error.response?.data?.message || 'An error occurred while updating the blog');
    } finally {
      setIsSubmitting(false);
    }
  };
        ...
        {isLoading ? (
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* <div>
                <label className="block text-gray-700 font-medium mb-2" htmlFor="edit-blog-content">
                ...
                <textarea
                  ...
                  className="block w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-y"
                  rows={8}
              ...
              <div>
                <label className="block text-gray-700 font-medium mb-2">
                  Blog Image {!currentBlogImage && <span className="text-red-500">*</span>}
                </label>
              ...
              <div>
                ...
                <div className="border border-gray-300 rounded-md p-4 bg-gray-50">
                  ...
                  {currentContentPhotos.length === 0 && contentPhotos.length === 0 && (
                    <div className="text-center py-4">

    ...
    return (
        <div className='flex flex-col w-full lg:px-[4rem] px-2 mt-6 py-12'>
            <div className="flex  md:w-[621px] flex-col justify-center m-auto items-center text-center space-y-2 p-3">
                  ...
                  <p className="test-sm">Dufite abafatanyabikorwa batanduka batuma tubasha kubagezaho telefoni nziza kandi mu buryo bunogeye buri wese. Menya byinshi kuribo </p>
            </div>

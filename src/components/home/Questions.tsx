...
const Questions = () => {
    ...
    return (
        <div className='flex flex-col w-full px-[4.8rem] mt-6 py-12'>
            <div className="flex  w-[621px] flex-col justify-center m-auto items-center text-center space-y-2 p-3">
                <h1 className="flex font-bold text-3xl" ><span>Frequently Asked</span> <span className="text-[#EDB62E] ml-2">Questions</span></h1>
            </div>
            <div className="w-[1170px] flex flex-col gap-3 py-12 mx-auto justify-center items-center">
                {questions.map((q) => (
